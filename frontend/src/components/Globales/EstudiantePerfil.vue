    ...
    <v-container  fluid >
        ...
        <v-dialog v-model="dialogSolicitud" persistent max-width="500px" >
            <v-card class="mx-auto" max-width="500" >
                ...
                <v-container class="px-5 mt-5">
                    <v-form  ref="form_solicitudEstudiante" style="margin:0;padding:0;" v-model="form_solicitarEstudianteValido" lazy-validation> 
                        ...
                        <div class="pb-1" style="text-align:right;">  
                            ...
                            :disabled="!form_solicitarEstudianteValido" >

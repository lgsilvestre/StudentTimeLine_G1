         ...
         <tr> 
          <td align="center"> 
           <table class="es-content-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"> 
             ...
             <tr> 
              <td class="es-p35b es-p30r es-p30l" align="left"> 
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="540" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                     <td class="es-p5t es-p10b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-color: #ec6d64; background: #4ecdc4; border-radius: 25px; border-width: 0px;"><a href="{{ $details['direccion'] }}" class="es-button" target="_blank" style="font-family: roboto, &quot;helvetica neue&quot;, helvetica, arial, sans-serif; font-size: 18px; background: #4ecdc4; border-color: #4ecdc4; color: #ffffff; text-shadow: #2d312d 2px 2px 3px; border-radius: 25px; border-width: 15px 25px;">Reestablecer contraseña</a></span></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                 ...
                 <tr> 
                  <td width="600" valign="top" align="center"> 
                   <table style="border-radius: 4px; border-collapse: separate; background-color: #111111;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#111111" role="presentation"> 
                     <tr> 
                      <td class="es-m-txt-l es-p5t es-p30r es-p30l" bgcolor="#ffe66d" align="left"><h2 style="color: #666666; font-size: 18px;"><strong>Nota</strong></h2></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
         ...
         <tr> 
          <td align="center"> 
           <table class="es-content-body" style="background-color: transparent;" width="600" cellspacing="0" cellpadding="0" align="center"> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="600" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-m-txt-l es-p5b es-p30r es-p30l" bgcolor="#ffe66d"><p style="color: #666666; text-align: justify; font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px;"><strong>Si usted no ha solicitado recuperar su contraseña, por favor, ignore este correo.</strong></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
             ...
             <tr> 
              <td class="es-p20t es-p30r es-p30l" align="left" bgcolor="#ffffff" style="background-color: #ffffff;"> 
